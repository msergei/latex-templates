% Главные модули
\documentclass[a4paper, 12pt, oneside]{scrartcl}								% Современые классы документов для отображения: scrbook, scrreprt, scrartcl, scrlttr2 and typearea
...
\usepackage[a4paper, top=10mm, left=10mm, right=10mm, bottom=10mm]{geometry}	% Задаем отступы: слева 30 мм, справа 10 мм, сверху до колонтитула 10 ммснизу 25 мм
